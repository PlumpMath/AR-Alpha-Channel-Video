...
<a href="https://developer.vuforia.com/legal/license" title="https://developer.vuforia.com/legal/license">https://developer.vuforia.com/legal/license</a>.
...
public class videoHandler : MonoBehaviour
{
        ...
        if (Input.touchCount > 0)
        {
            ...
            else if (touch.phase == TouchPhase.Ended)
            {
                if (!mTouchMoved && mTimeElapsed < 1.0)
                {
                    ...
                    {
                        // Second tap
                        //HandleDoubleTap(); Do not enter fullscreen
                        mTapped = false;
                    }
                    else
                    {
    ...
    /*void OnGUI()
    {
        GUI.Box(new Rect(10, 100, 600, 90), details);
        //GUI.Label(new Rect(10, 100, 600, 100), "----> " + label);
    }*/
}